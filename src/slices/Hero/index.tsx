...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  useEffect (()=>{
    let ctx = gsap.context(()=>{
      ...
      tl.fromTo(".name-animation",{x:-100,opacity:0,rotate:-10},{x:0,opacity:1,rotate:0,ease:"elastic.out(1,0.3)",duration:1,transformOrigin:"left top",delay:0.5,stagger:{each:0.1,from:"random"}})
